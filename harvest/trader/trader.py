...
class Trader:
    ...
    def _setup(self, interval, aggregations, sync=True):
        ...
        self.debugger.debug(f"Sync: {sync}")
        if sync:
            self._setup_stats()
    ...
    def _setup_stats(self):
        ...
        self.debugger.debug("Fetching option data")
        # Update option stats
    ...
    def timeout(self):
        self.debugger.debug("Begin timer")
        time.sleep(1)
